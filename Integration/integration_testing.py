...
def test_negative_case_1():
    ...
    assert len(cart.items) == 1, "Negative Test Case 1 Failed: Removing a non-existent item"
...
def test_negative_case_2():
    ...
    total = cart.calculate_total()
    assert total == 0, "Negative Test Case 2 Failed: Total Calculation with no items"
